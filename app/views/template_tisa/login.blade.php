...
<body>
	<div class="login_container">
		...
		{{ Form::open(array('url'=>'login', 'method' => 'post', 'id'=>'login_form')) }}
			@foreach($errors->all() as $message)
				<p><code><small>{{ $message }}</small></code></p>
			@endforeach
			<h1 class="login_heading"> Bienvenido/a </h1>
			<div class="form-group">
				{{ Form::label('email', 'Email', array('for'=>'login_username')) }}
				{{ Form::text('email', '', array('class'=>'form-control input-lg', 'id'=>'login_username')) }}
				<!-- <label for="login_username">Username</label>
				<input type="text" class="form-control input-lg" value="User" id="login_username"> -->
			</div>
			<div class="form-group">
				{{ Form::label('password', 'Clave', array('for'=>'login_password')) }}
				{{ Form::password('password', array('class'=>'form-control input-lg', 'id'=>'login_password')) }}
				<span class="help-block"><a href="login_page.html#">Olvidé mi clave.</a></span>
			</div>
		...
		<form id="register_form" style="display:none">
			...
			<h1 class="login_heading">Register <span>/ <a href="login_page.html#" class="open_login_form">login</a></span></h1>
