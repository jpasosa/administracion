...
<!-- Esto es el menú de la derecha, que por lo que veo no se está utilizando -->
<div id="slidebar_content">
	...
	<div class="user_img_grid clearfix">
		<a class="user_img_item" href="index.html#"><img src="assets/img/avatars/avatar_3.jpg" alt="" class="img-thumbnail"></a>
		<a class="user_img_item" href="index.html#"><img src="assets/img/avatars/avatar_5.jpg" alt="" class="img-thumbnail"></a>
		<a class="user_img_item" href="index.html#"><img src="assets/img/avatars/avatar_8.jpg" alt="" class="img-thumbnail"></a>
		<a class="user_img_item" href="index.html#"><img src="assets/img/avatars/avatar_6.jpg" alt="" class="img-thumbnail"></a>
	</div>
	<hr>
	<form>
